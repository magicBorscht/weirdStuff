...
switcher = 0    # Переключение в режим тупицы, в качестве стратегии берутся переменные raz - кол-во дисплеев
raz = 3         # и dva - кол-во джеков
dva = 4

i_am_lazy = 1000    # Количество ходов (мне было лень листать в конец файла)
...
def wisdom(strategies, needs):
    ...
    # [3, 3] - одна из наиболее живучих стратегий на тестах. Она стабильно вывозит при тестах, так что я вбил
